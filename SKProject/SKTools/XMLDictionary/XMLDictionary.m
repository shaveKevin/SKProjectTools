...
+ (NSDictionary *)dictionaryWithXMLString:(NSString *)string
{
    ...
    NSError *error = NULL;
    NSRegularExpression *regex = [NSRegularExpression regularExpressionWithPattern:@"[\\x00-\\x08\\x0b-\\x0c\\x0e-\\x1f]"
	...
	return [[[XMLDictionaryParser sharedInstance] copy] dictionaryWithString:content];
}
